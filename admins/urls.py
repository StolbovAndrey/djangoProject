...
from admins.views import IndexAdminListView, UserAdminListView, UserAdminCreateView, UserAdminUpdateView, UserAdminDeleteView

app_name = 'admins'

urlpatterns = [
    path('', IndexAdminListView.as_view(), name='index'),
